package com.deskchairtapioca.blong 
{
	...
	public class UpdateFrameEvent extends Event
	{
		...
		public function UpdateFrameEvent(type:String, delta:Number, pressedKeys:Vector.<Boolean>, bubbles:Boolean = false, cancelable:Boolean = false) 
		{
		...
		{
			return new UpdateFrameEvent(type, this.delta, this.pressedKeys, bubbles, cancelable);
		}
